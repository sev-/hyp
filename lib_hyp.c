/*
 *  $Id: lib_hyp.c,v 1.2 1993/04/22 15:33:35 sev Exp $
 *
 * ---------------------------------------------------------- 
 *
 * $Log: lib_hyp.c,v $
 * Revision 1.2  1993/04/22 15:33:35  sev
 * Добавлена еще одна функция - запись сегмента в файл
 *
 * Revision 1.1  1993/03/04  09:50:57  sev
 * Initial revision
 *
 *
*/

static char rcsid[]="$Id: lib_hyp.c,v 1.2 1993/04/22 15:33:35 sev Exp $";
...
int mode;
{
  ...
  switch(mode)
  {
    case 0:                  /*       любая клавиша   */
      ...
      break;
    case 1:                  /*       ДА или НЕТ   */
      xatsay(2, (width-14)/2, "  НЕТ    ДА  ", ATTR_F);
      while(more)
      {
