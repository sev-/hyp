/*
 *  $Id: print_seg.c,v 1.1 1994/03/05 21:56:56 sev Exp $
 *
 * ---------------------------------------------------------- 
 *
 * $Log: print_seg.c,v $
 ...
 * Initial revision
 *
 * Revision 1.3  1993/05/22  12:03:07  sev
 * Исправлена ошибка при записи сегмента (при отказе было перелистывание
 * экрана)
 *
 * Revision 1.2  1993/04/22  15:42:07  sev
 * Delete some errors
 *
 * Revision 1.1  1993/04/22  15:33:35  sev
 * Initial revision
 *
 *
 */
